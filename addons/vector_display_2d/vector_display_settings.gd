...
## Apply dimming even when vectors are normalized
@export var dimming_if_normalized: bool = false
## Apply dimming based on actual value (with scale) of vector or visual length
@export_enum("Absolute", "Visual") var normalized_dimming_type: String = "Absolute"
